...
FORWARD_IPCS_DT = 5.0e-6 #1.0e-5
FORWARD_IPCS_MAX_ITERS = 400 #700
FORWARD_IPCS_VELOCITY_RTOL = 3.0e-4 #1.0e-4
FORWARD_IPCS_PRESSURE_RTOL = 1.0e-3 #2.0e-3
FORWARD_IPCS_VEL_RELAXATION = 0.10 #0.15
FORWARD_IPCS_P_RELAXATION = 0.03 #0.05
FORWARD_IPCS_MAX_RESTARTS = 3 #6
