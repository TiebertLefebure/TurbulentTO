...
# Old J_p run: weak Brinkman impedance and penalty settings were important for
# reproducing the Alexandersen-like bend topology.
...
if CONTINUATION_VARIANT == "single_stage_500":
    ...
    BETA_PROJ_SCHEDULE_JP = [4.0, 4.5, 5.0, 6.0, 7.0, 8.0, 9.0]
    MOVE_LIMIT_SCHEDULE_JP = [0.010, 0.004, 0.0035, 0.003, 0.0025, 0.002, 0.0015]
    MAX_INNER_ITERATIONS_SCHEDULE_JP = [70, 80, 90, 110, 130, 160, 200]
    OBJECTIVE_CONVERGENCE_TOL_JP = 1.0e-5
    OBJECTIVE_STREAK_TO_STOP_JP = 14
