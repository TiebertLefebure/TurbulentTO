...
# ===================================================================
# Remote override: old J_p settings.
#
# The remote pipebend_frozen compose target runs this config directly.
# Keep this block at the end so these archived settings win over the
# production continuation values above.
# ===================================================================

USE_OLD_JP_REMOTE_SETTINGS = True

if USE_OLD_JP_REMOTE_SETTINGS:
    RESUME_OPTIMIZATION = False

    VOL_FRAC = 0.25
    OBJECTIVE_TYPE = "average_inlet_pressure"
    _OBJECTIVE_TYPE_NORMALIZED = OBJECTIVE_TYPE.strip().lower()
    _USE_PRESSURE_OBJECTIVE = True
    _USE_DISSIPATION_OBJECTIVE = False
    INITIAL_DENSITY_VALUE = VOL_FRAC
    INITIAL_DENSITY_MATCH_FILTERED_VOLUME = True
    ...
    FORWARD_IPCS_VELOCITY_RTOL = 5.0e-4
    FORWARD_IPCS_PRESSURE_RTOL = 5.0e-3
