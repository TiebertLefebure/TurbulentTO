...
# J_D keeps the current robust path. J_p follows the running UBend pressure
# path, with slightly slower moves for the sharper pipe-bend objective.
...
MOVE_LIMIT_SCHEDULE_JP = [0.010, 0.008, 0.006, 0.004, 0.003]
MAX_INNER_ITERATIONS_SCHEDULE_JP = [70, 80, 100, 120, 160]
