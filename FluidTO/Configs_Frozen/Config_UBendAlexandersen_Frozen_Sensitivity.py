...
#
# This intentionally inherits the current U-bend J_p setup so the frozen
# derivative is checked on the same objective, turbulence penalties, wall-
# distance convention, and continuation controls used by the active benchmark.
# The finite-difference perturbations keep the SA working variable and
# reciprocal wall-distance field frozen, matching the frozen-turbulence
# adjoint derivative being checked.

RESUME_OPTIMIZATION = False
OBJECTIVE_TYPE = "average_inlet_pressure"
RESULTS_ROOT_NAME = "Results_Frozen/Results_UBendAlexandersen_Frozen_Jp_Sensitivity"
