...
# ============================================================================================
# Reynolds number: Re = U_MAX_INLET * PORT_WIDTH * RHO_FLUID_VALUE / MU_FLUID_VALUE = 1.0
# ============================================================================================
...
# Keep the early stages permissive so the two-channel layout can form, then
# spend more stages on projection sharpening with progressively smaller MMA moves.
Q_PENAL_SCHEDULE = [0.005, 0.01, 0.02, 0.03, 0.05, 0.10, 0.20, 0.35, 0.50]
MOVE_LIMIT_SCHEDULE = [0.03, 0.03, 0.025, 0.02, 0.015, 0.01, 0.0075, 0.005, 0.003]
