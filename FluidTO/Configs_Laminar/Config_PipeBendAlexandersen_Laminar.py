...
Q_PENAL_SCHEDULE = [0.01, 0.02, 0.04, 0.08, 0.08, 0.12, 0.20, 0.20]
BETA_PROJ_SCHEDULE = [1.0, 2.0, 4.0, 8.0, 8.0, 12.0, 16.0, 16.0]
MOVE_LIMIT_SCHEDULE = [0.010, 0.008, 0.006, 0.004, 0.003, 0.002, 0.0015, 0.0015]
MAX_INNER_ITERATIONS_SCHEDULE = [12, 25, 45, 80, 120, 160, 220, 200]
...
RESULTS_ROOT_BASE_NAME = "Results_Laminar/Results_PipeBendAlexandersen_Laminar"
