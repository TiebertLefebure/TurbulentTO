...
# ===================================================================
# Configuration: Dilgen 2018 2D Flow Manifold - Turbulent SemiFrozen
#
...
#   and outlet mass-flow constraints, but target the SemiFrozen adjoint:
#   the primal state stays monolithic in (u, p, nu_tilde) while the
#   reciprocal wall-distance G is updated externally.
# ===================================================================
...
RESULTS_ROOT_NAME = 'Results_SemiFrozen/Results_ManifoldDilgen_TurbulentTO_SemiFrozen'
