...
% --TO BE FILLED IN--
\noindent
\textbf{Student name:} Tiebert Lefebure \hfill \textbf{Student number:} r0887630
...
\textbf{Title:} Topology optimization of flow configurations operating in the turbulent regime 
 
\textbf{Supervisors:} Prof. Dr. Ir. Niels Horsten \& Prof. Dr. Ir. Maarten Blommaert   


\vspace{1em}

\textbf{Daily supervisor:} Esteban Foronda Obando 
...
X I \textbf{did use} GenAI Assistance. In this case \textbf{specify which ones} (e.g.\ ChatGPT, M365 Copilot, …): Gemini, ChatGPT
...
\textbf{As a language assistant for reviewing or improving texts I wrote myself} & Google Gemini \& ChatGPT. Improving level of academic language, grammar check, spelling check. & This use is similar to using spelling and grammar check tools. In general, you do not have to refer to such kind of GenAI use in the text. 
...
\end{itemize} \\ \hline
\textbf{For literature search} & Google Gemini \& ChatGPT. Finding papers on certain topics. Literature is referenced. & This use is comparable to e.g.\ a Google Scholar search. You do not have to refer to such kind of GenAI use; \textbf{you only have to \href{https://bib.kuleuven.be/english/training-and-tutorials/citation}{refer} to the literature references you have checked and used} (without such references you would be committing \href{https://www.kuleuven.be/english/education/plagiarism/index}{plagiarism} and thus committing an irregularity).
...
\end{itemize} \\ \hline
\textbf{For generating visuals, video or audio} & ChatGPT. Image generation of geometry set-ups, algorithmic workflows, theoretical concepts. & Use of GenAI for generating visuals, audio or video is allowed except when it is prohibited by the teacher or the program of study. 
