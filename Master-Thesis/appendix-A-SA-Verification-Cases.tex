...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=0.8\textwidth]{example-image} % Replace with your Ansys channel mesh independence plot
...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=0.8\textwidth]{example-image} % Replace with your U-bend mesh independence velocity profile plot
...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=0.8\textwidth]{example-image} % Replace with your Ansys U-bend mesh independence velocity profile plot
