...
\begin{table}[htbp]
	...
	\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}lccc@{}}
		...
		$\Delta p^{\mathrm{SA}}$ [Pa] & $0.1423$ & $0.1449$ & $0.1457$ \\
		$\epsilon_{\mathrm{rel}}(\Delta p^{\mathrm{SA}})$ [\%] & -- & $1.84$ & $0.55$ \\
		$\Delta p^{\mathrm{SST}}$ [Pa] & $0.1481$ & $0.1516$ & $0.1522$ \\
		$\epsilon_{\mathrm{rel}}(\Delta p^{\mathrm{SST}})$ [\%] & -- & $2.36$ & $0.40$ \\
		Selected validation mesh & \multicolumn{3}{c}{Fine\_Ansys} \\
		\hline
	\end{tabular*}
	\vspace{2pt}
	\begin{minipage}{0.98\textwidth}
		\scriptsize \textit{Note.} WR = wall-resolved; $\Phi_D$ = viscous dissipation; $\Delta p$ = static pressure drop; SST denotes SST $k$--$\omega$. For $\epsilon_{\mathrm{rel}}$ rows, the Medium column gives the Coarse--Medium change and the Fine column gives the Medium--Fine change.
	\end{minipage}
\end{table}
...
\begin{table}[htbp]
	...
	\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}lccc@{}}
		...
		$\epsilon_{\mathrm{rel}}(\Delta p^{\mathrm{SA}})$ [\%] & -- & [TBD] & [TBD] \\
		$\Delta p^{\mathrm{SST}}$ [Pa] & [TBD] & [TBD] & [TBD] \\
		$\epsilon_{\mathrm{rel}}(\Delta p^{\mathrm{SST}})$ [\%] & -- & [TBD] & [TBD] \\
...
\begin{table}[htbp]
	...
	\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}lccc@{}}
		...
		$\Delta p^{\mathrm{SA}}$ [Pa] & $1.2460\times10^{5}$ & $1.2449\times10^{5}$ & $1.2422\times10^{5}$ \\
		$\epsilon_{\mathrm{rel}}(\Delta p^{\mathrm{SA}})$ [\%] & -- & $0.09$ & $0.22$ \\
		$\Delta p^{\mathrm{SST}}$ [Pa] & $4.2412\times10^{4}$ & $4.2034\times10^{4}$ & $4.1833\times10^{4}$ \\
		$\epsilon_{\mathrm{rel}}(\Delta p^{\mathrm{SST}})$ [\%] & -- & $0.89$ & $0.48$ \\
		Selected validation mesh & \multicolumn{3}{c}{Fine\_Ansys} \\
		\hline
	\end{tabular*}
	\vspace{2pt}
	\begin{minipage}{0.98\textwidth}
		\scriptsize \textit{Note.} WR = wall-resolved; ST = smooth-transition; $\Phi_D$ = viscous dissipation; $\Delta p$ = static pressure drop; SST denotes SST $k$--$\omega$. For $\epsilon_{\mathrm{rel}}$ rows, the Medium column gives the Coarse--Medium change and the Fine column gives the Medium--Fine change.
	\end{minipage}
\end{table}
