...
\begin{table}[htbp]
	\centering
	\footnotesize
	\caption{Shared wall-distance and SA topology-penalty conventions for the pipe-bend and U-bend benchmarks.}
...
\begin{table}[htbp]
	...
	\begin{tabular}{@{}lccc@{}}
		...
		Bulk face element size [m] & $7.50 \times 10^{-3}$ & $5.00 \times 10^{-3}$ & $3.25 \times 10^{-3}$ \\
		Curvature angle & $10^\circ$ & $7^\circ$ & $4.5^\circ$ \\
		...
		Inflation layers & $12$ & $14$ & $18$ \\
		Growth rate & $1.12$ & $1.10$ & $1.08$ \\
		Inflation thickness [m] & $1.45 \times 10^{-2}$ & $1.68 \times 10^{-2}$ & $2.25 \times 10^{-2}$ \\
		Nodes & $10{,}825$ & $21{,}343$ & $44{,}042$ \\
		Elements & $15{,}834$ & $32{,}780$ & $68{,}743$ \\
		Viscous dissipation $\Phi_D^{\mathrm{SA}}$ [W/m] & $0.0149$ & $0.0151$ & $0.0153$ \\
		Relative change $\Phi_D^{\mathrm{SA}}$, Coarse--Medium & -- & $1.34\%$ & -- \\
		Relative change $\Phi_D^{\mathrm{SA}}$, Medium--Fine & -- & -- & $1.32\%$ \\
		Viscous dissipation $\Phi_D^{\mathrm{SST}\ k\text{-}\omega}$ [W/m] & $0.0161$ & $0.0164$ & $0.0166$ \\
		Relative change $\Phi_D^{\mathrm{SST}\ k\text{-}\omega}$, Coarse--Medium & -- & $1.86\%$ & -- \\
		Relative change $\Phi_D^{\mathrm{SST}\ k\text{-}\omega}$, Medium--Fine & -- & -- & $1.22\%$ \\
		Static pressure drop $\Delta p^{\mathrm{SA}}$ [Pa] & $0.1442$ & $0.1449$ & $0.1457$ \\
		Relative change $\Delta p^{\mathrm{SA}}$, Coarse--Medium & -- & $0.49\%$ & -- \\
		Relative change $\Delta p^{\mathrm{SA}}$, Medium--Fine & -- & -- & $0.55\%$ \\
		Static pressure drop $\Delta p^{\mathrm{SST}\ k\text{-}\omega}$ [Pa] & $0.1512$ & $0.1516$ & $0.1522$ \\
		Relative change $\Delta p^{\mathrm{SST}\ k\text{-}\omega}$, Coarse--Medium & -- & $0.26\%$ & -- \\
...
The diffuser case follows Fig.~20--22 of Yoon~\cite{Yoon2016}. Unlike the pipe-bend and U-bend benchmarks, the diffuser prescribes parabolic velocity profiles at both the inlet and the outlet and uses the dissipation objective $J_D$.
