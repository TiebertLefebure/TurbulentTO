...
\begin{figure}[!ht]
	...
	\caption{Topology-optimized heat sink from Barroca et al.~\cite{Barroca2023}, showing the optimized fin layout with velocity magnitude (left) and temperature (right).}
...
\begin{figure}[htpb]
	...
	\begin{subfigure}[b]{0.28\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Initial-Density-Field}
	...
	\begin{subfigure}[b]{0.28\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Intermediate-Density-Field}
	...
	\begin{subfigure}[b]{0.40\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Final-Density-Field}
...
\begin{enumerate}
	...
	Chapter~\ref{ch:benchmark_results} answers this question using the pipe-bend, U-bend, and diffuser benchmarks. It reports the FEniCS optimizations, sharp-geometry Ansys-SA validation, SST $k-\omega$ re-analysis, and laminar-versus-turbulent design comparisons. Appendix~\ref{app:C_topology_optimization_benchmarks} contains the supporting frozen-sensitivity verification.
\end{enumerate}
