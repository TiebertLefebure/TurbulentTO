...
All mesh-independence relative differences referenced from Appendix~\ref{app:A_baseline_configurations} follow the appendix convention: coarse--medium differences are normalized by the coarse value, while medium--fine differences are normalized by the fine value.
