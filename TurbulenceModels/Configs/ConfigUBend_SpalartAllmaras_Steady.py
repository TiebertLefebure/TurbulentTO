...
COUPLED_PICARD_SA_RELAXATION = 0.005
...
steady_sa_solver_parameters = {
    ...
    "PRESSURE_DROP_CONVERGENCE_WINDOW": PRESSURE_DROP_CONVERGENCE_WINDOW,
    "PRESSURE_DROP_CONVERGENCE_RELATIVE_TOLERANCE": PRESSURE_DROP_CONVERGENCE_RELATIVE_TOLERANCE,
    "PRESSURE_DROP_CONVERGENCE_REQUIRE_FLOW": PRESSURE_DROP_CONVERGENCE_REQUIRE_FLOW,
