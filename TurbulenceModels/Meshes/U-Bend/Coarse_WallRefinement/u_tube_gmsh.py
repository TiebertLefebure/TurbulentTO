...
# Coarse base size + wall refinement settings
LC_BULK = D_PIPE / 10.0
LC_WALL = D_PIPE / 30.0
WALL_BAND = 0.10 * D_PIPE
DIST_SAMPLING = 120


def create_mesh(output_filename='u_bend_2d.msh'):
    gmsh.initialize()
    gmsh.model.add('U_bend_2D_Coarse_WallRefinement')
    ...
    # Distance-to-wall based mesh size field.
    # Size transitions from LC_WALL at walls to LC_BULK beyond WALL_BAND.
    ...
    print(f'Wrote coarse wall-refined mesh: {output_filename}')
