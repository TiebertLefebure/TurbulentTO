...
# SA_NU_TILDE_INLET = 1.0e-3 with nu_lam = MU_FLUID_VALUE / RHO_FLUID_VALUE = 1.0e-2.
...
#   These match the shared defaults in TurbulentTO.py and are written here
...
RESULTS_ROOT_NAME = "Results_DiffuserBorrvall_TurbulentTO"
