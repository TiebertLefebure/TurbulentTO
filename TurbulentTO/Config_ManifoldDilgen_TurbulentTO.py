...
mesh_files = {
    'MESH_DIRECTORY': os.path.join(THIS_DIR, 'Meshes/ManifoldDilgen/mesh.xdmf'),
}
...
# -------------------------------------------------------------------
RHO_FLUID_VALUE = 1.0
MU_FLUID_VALUE = 5.7e-5
U_BULK_INLET = 2.0
U_MAX_INLET = 1.5 * U_BULK_INLET

# ----------------------------------------------------------------------------------------------
# Reynolds number: Re = U_BULK_INLET * H * RHO_FLUID_VALUE / MU_FLUID_VALUE = 3,500
# ----------------------------------------------------------------------------------------------
...
RESULTS_ROOT_NAME = "Results_ManifoldDilgen_TurbulentTO"
